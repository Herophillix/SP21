...
void movebullet()
{
	if (Bulletpos == true)
	{
		...
		case 1:
		{
			if (Maze[g_bullet.m_cLocation.Y - 2][g_bullet.m_cLocation.X] != (char)219)
			{
		...
		case 2:
		{
			if (Maze[g_bullet.m_cLocation.Y - 1][g_bullet.m_cLocation.X + 1] != (char)219)
			{
		...
		case 3:
		{
			if (Maze[g_bullet.m_cLocation.Y][g_bullet.m_cLocation.X] != (char)219)
			{
				g_bullet.m_cLocation.Y++;
			}
			else
