...
int bossAttackMax = 0;
int bossAttackFrame[2] = {0, 0};
int k = 0;
int bossAttackOn[2] = {false, false};
...
std::vector <SGameChar> g_bossSubBullet;
...
{
	SGameChar tempChar;
	tempChar.m_cLocation.X = g_bossSubGun1.m_cLocation.X;
	tempChar.m_cLocation.Y = g_bossSubGun1.m_cLocation.Y;
	return tempChar;
}