...
int one = 1;
int two = 1;
int enemylocationX = 50;
int enemylocationY = 29;
int enemy1locationX = 50;
int enemy1locationY = 12;
int enemy2locationX = 50;
int enemy2locationY = 13;
int enemy3locationX = 54;
int enemy3locationY = 3;
int enemy4locationX = 32;
int enemy4locationY = 3;
int enemy5locationX = 31;
int enemy5locationY = 20;
